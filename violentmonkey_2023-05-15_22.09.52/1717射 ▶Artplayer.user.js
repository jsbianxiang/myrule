// ==UserScript==
// @name         1717射 ▶Artplayer
// @namespace    https://greasyfork.org/zh-CN/users/108076
// @version      1.0.0
// @description  免登录，直接播放VIP视频！2023年1月25日。
// @author       草木灰
// @match        *://1717se.cc/video/*
// @match        *://91xx.one/video/*
// @icon         https://www.google.com/s2/favicons?domain=theporn.cc
...
(function () {
    ...
    if ($(".vip_container").length === 1) {
        // 播放器覆盖
        $('div.__video_player_container.row.m-100.__player__container').html('<div class="artplayer-app"></div>');
