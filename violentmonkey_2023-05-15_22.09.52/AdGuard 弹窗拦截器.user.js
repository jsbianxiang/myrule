...
// @description:de Sperrt Werbe-Pop-ups auf Websites
...
// @description:nl Blokkeert pop-up ads op webpagina's
...
Q.prototype.i=function(){var a=R.indexOf(this);if(-1!==a){R.splice(a,1);a=this.s;var b=a.parentNode;b&&b.removeChild(a);a.removeEventListener("load",this);this.s=void 0;ka&&0===R.length&&(a=Cc.host,(b=a.parentNode)&&b.removeChild(a),Cc=void 0)}};var Dc="display block position relative width 0 height 0 margin 0 padding 0 overflow hidden z-index 2147483647".split(" "),R=[];var Ec={Ba:!0};function S(){throw Error("Do not instantiate directly");}S.prototype.P=null;S.prototype.getContent=function(){return this.content};S.prototype.toString=function(){return this.content};function Fc(a){if(null!=a)switch(a.P){case 1:return 1;case -1:return-1;case 0:return 0}return null}function Gc(){S.call(this)}xc(Gc,S);Gc.prototype.ca=Ec;function U(a){return null!=a&&a.ca===Ec?a:Hc(String(String(a)).replace(Ic,Jc),Fc(a))}function Kc(){S.call(this)}xc(Kc,S);Kc.prototype.ca={}.za;function Lc(a){function b(){}b.prototype=a.prototype;return function(a,d){var c=new b;c.content=String(a);void 0!==d&&(c.P=d);return c}}var Hc=Lc(Gc);Lc(Kc);
...
function fd(a,b){clearTimeout(a.a);switch(b){case 1:requestAnimationFrame(function(){a.b.classList.add("z-b-A")});a.a=setTimeout(function(){fd(a,2)},gd);break;case 2:a.b.classList.add("z-b-A");a.a=setTimeout(function(){fd(a,3)},a.A);break;case 3:a.b.classList.remove("z-b-A");a.a=setTimeout(function(){fd(a,0)},gd);break;case 0:dd(a),a.a=void 0}a.j=b}var ed="position fixed bottom 15px width 0px height 0px border none z-index 2147483647".split(" "),gd=300;function hd(a){var b=id;this.j=new jd;this.l=b;this.U=a;this.wa=ma(null);this.b=0;this.F=t.call(this.F,this);this.m=t.call(this.m,this);this.i=t.call(this.i,this);this.L=t.call(this.L,this);this.ya=new ad(this.j)}function W(a,b,c){clearTimeout(a.f);b?(a.f=wa(b,c),a.A=Date.now(),a.u=c):a.f=a.A=a.u=null}n=hd.prototype;n.F=function(){this.a.F();this.b=1;W(this,this.m,kd);this.c=null};n.m=function(){this.a.m();this.b=2;W(this,this.i,kd);this.c=null};
n.i=function(){this.a&&(this.a.i(),this.a=null);this.b=0;W(this);this.c=null};function ld(a,b,c){var d=a.wa;d=p(d[b])?d[b]=1:++d[b];a.a||(a.a=new V(a.j,a));var e={ka:b,oa:c};Pc(a.a,d,b,c,function(){a.g=e});switch(a.b){case 0:a.b=1;W(a,a.m,kd);break;case 1:W(a,a.m,kd)}}n.M=function(){"number"===typeof this.f&&(this.c=this.u-(Date.now()-this.A),W(this))};n.N=function(){if("number"===typeof this.c){var a=this.c,b=md;W(this,1===this.b?this.m:this.i,a>b?a:b);this.c=null}};n.V=function(){this.m()};
...
settings_saved:"Nastavení uložena",show_popup:"Zobrazit {$destUrl}",continue_blocking:"Pokračovat v blokování",allow_from:"Povolit vyskakovací okna na {$origDomain}",manage_pref:"Spravovat předvolby",popup_text:"AdGuard zabránil tomu, aby tato webová stránka otevřela vyskakovací okna: {$numPopup}",options:"Možnosti",silence_noti:"Tuto zprávu nezobrazovat na {$origDomain}"},da:{userscript_name:"AdGuard Popup Blocker",on_navigation_by_popunder:"Denne overgang til den nye side skyldes sandsynligvis en pop-under. Fortsæt?",
aborted_popunder_execution:"Popup Blocker afbrød en scripteksekvering for at forhindre baggrundsomdirigering",settings_saved:"Indstillinger gemt",show_popup:"Vis {$destUrl}",continue_blocking:"Fortsæt blokering",allow_from:"Tillad pop-ups på {$origDomain}",manage_pref:"Håndtere præferencer...",popup_text:"AdGuard forhindrede dette websted i at åbne {$numPopup} pop op-vinduer",options:"Valgmuligheder",silence_noti:"Vis ikke denne meddelelse på {$origDomain}"},de:{userscript_name:"AdGuard Pop-up-Blocker",
on_navigation_by_popunder:"Diese Seiten-Navigation wird wahrscheinlich durch ein Pop-under verursacht. Möchten Sie fortfahren?",aborted_popunder_execution:"Pop-up-Blocker hat eine Skript-Ausführung abgebrochen, um eine Hintergrundumleitung zu verhindern",settings_saved:"Einstellungen gespeichert",show_popup:"{$destUrl} anzeigen",continue_blocking:"Weiterhin sperren",allow_from:"Pop-ups auf {$origDomain} zulassen",manage_pref:"Einstellungen verwalten …",popup_text:"AdGuard hat auf dieser Website {$numPopup} Pop-up-Fenster verhindert",
options:"Optionen",silence_noti:"Diese Nachricht auf {$origDomain} nicht anzeigen"},el:{userscript_name:"Αποκλεισμός αναδυόμενων παραθύρων AdGuard",on_navigation_by_popunder:"Αυτή η μετάβαση σε νέα σελίδα είναι πιθανό να προκαλείται από ένα αναδυόμενο παράθυρο. Θέλετε να συνεχίσετε;",aborted_popunder_execution:"Το Αποκλεισμός αναδυόμενων παραθύρων ακύρωσε μια εκτέλεση σεναρίου για να αποτρέψει την ανακατεύθυνση του φόντου",settings_saved:"Οι ρυθμίσεις αποθηκεύτηκαν",show_popup:"Εμφάνιση {$destUrl}",
continue_blocking:"Συνέχεια αποκλεισμού",allow_from:"Να επιτρέπονται τα αναδυόμενα παράθυρα για το {$origDomain}",manage_pref:"Διαχείριση προτιμήσεων...",popup_text:"Το AdGuard εμπόδισε αυτόν τον ιστότοπο να ανοίξει {$numPopup} αναδυόμενα παράθυρα",options:"Επιλογές",silence_noti:"Να μην εμφανίζεται αυτό το μήνυμα στο {$origDomain}"},es:{userscript_name:"AdGuard Popup Blocker",on_navigation_by_popunder:"Es probable que esta transición a la nueva página sea causada por un elemento emergente. ¿Deseas continuar?",
aborted_popunder_execution:"Popup Blocker canceló la ejecución de un script para evitar la redirección en segundo plano",settings_saved:"Ajustes guardados",show_popup:"Mostrar {$destUrl}",continue_blocking:"Continuar bloqueando",allow_from:"Permitir ventanas emergentes en {$origDomain}",manage_pref:"Administrar preferencias...",popup_text:"AdGuard impidió que este sitio web abriera {$numPopup} ventanas emergentes",options:"Opciones",silence_noti:"No mostrar este mensaje en {$origDomain}"},fa:{userscript_name:"مسدودساز پاپ-آپ AdGuard",
on_navigation_by_popunder:"انتقال به این صفحه جدید احتمالا بخاطر یه پاپ-آندر انجام شده است. میخواهید ادامه دهید؟",aborted_popunder_execution:"مسدودساز پاپ-آپ اجرای کد را لغو کرده تا از ریدایرکت جبلوگیری شود",settings_saved:"تنظيمات ذخیره شد",show_popup:"نمایش {$destUrl}",continue_blocking:"ادامه مسدودسازی",allow_from:"اجازه پاپ آپ ها در {$origDomain}",manage_pref:"مدیریت اولویت ها...",popup_text:"AdGuard این وبسایت را از بازکردن {$numPopup} پنجره پاپ آپ جلوگیری کرد",options:"گزینه ها",silence_noti:"این پیام را نشان نده در {$origDomain}"},
fi:{userscript_name:"AdGuard Ponnahdusesto",on_navigation_by_popunder:"Siirtyminen toiselle sivulle johtui todennäköisesti taustalle piilottuneesta ponnahduksesta. Haluatko jatkaa?",aborted_popunder_execution:"Ponnahdusesto keskeytti komentosarjan estääkseen taustalla tapahtuvan uudelleenohjauksen",settings_saved:"Asetukset tallennettiin",show_popup:"Avaa {$destUrl}",continue_blocking:"Jatka estoa",allow_from:"Salli ponnahdukset verkkotunnuksella {$origDomain}",manage_pref:"Hallinnoi asetuksia...",
popup_text:"AdGuard esti tätä verkkosivustoa avaamasta {$numPopup} ponnahdusta",options:"Valinnat",silence_noti:"Älä näytä tätä viestiä sivustolla {$origDomain}"},fr:{userscript_name:"Bloqueur de fenêtres pop-up de AdGuard",on_navigation_by_popunder:"Cette transition vers la nouvelle page est susceptible d'être causée par un pop-under. Désirez-vous continuer?",aborted_popunder_execution:"Le bloqueur de pop-ups a interrompu l'exécution d'un script pour empêcher une redirection en arrière-plan",settings_saved:"Paramètres sauvegardés",
show_popup:"Afficher {$destUrl}",continue_blocking:"Continuer le blocage",allow_from:"Autoriser fenêtres pop-up pour {$origDomain}",manage_pref:"Administrer les préférences...",popup_text:"AdGuard a empêché ce site web d'afficher {$numPopup} fenêtres pop-up",options:"Options",silence_noti:"Ne pas afficher ce message sur {$origDomain}"},he:{userscript_name:"חוסם חלונות קופצים של AdGuard",on_navigation_by_popunder:"מעבר זה אל הדף החדש כנראה נגרם ע״י חלון קופץ מתחת. האם אתה רוצה להמשיך?",aborted_popunder_execution:"חוסם החלונות הקופצים ביטל ביצוע תסריט כדי למנוע הכוונה ברקע",
settings_saved:"הגדרות נשמרו",show_popup:"הראה את {$destUrl}",continue_blocking:"המשך לחסום",allow_from:"התר חלונות קופצים עבור {$origDomain}",manage_pref:"נהל העדפות…",popup_text:"AdGuard מנע מאתר זה לפתוח {$numPopup} חלונות קופצים",options:"אפשרויות",silence_noti:"אל תראה הודעה זו בתחום {$origDomain}"},hu:{userscript_name:"AdGuard Popup Blocker",on_navigation_by_popunder:"Az új oldalra való áttérést valószínűleg egy előugró ablak okozza. Kívánja folytatni?",aborted_popunder_execution:"A Popup Blocker megszakította a szkript végrehajtását a háttérben történő átirányítás megakadályozása érdekében",
settings_saved:"Beállítások mentve",show_popup:"Mutasd {$destUrl}",continue_blocking:"Blokkolás folytatása",allow_from:"Felugró ablakok engedélyezése itt: {$origDomain}",manage_pref:"Beállítások kezelése...",popup_text:"Az AdGuard {$numPopup} felugró ablak megjelenését akadályozta meg",options:"Beállítások",silence_noti:"Ne mutassa ezt az üzenetet itt: {$origDomain}"},id:{userscript_name:"Pemblokir Popup AdGuard",on_navigation_by_popunder:"Transisi ke laman baru ini kemungkinan disebabkan oleh sebuah pop-up. Apakah Anda ingin melanjutkan?",
aborted_popunder_execution:"Popup Blocker menghentikan eksekusi skrip untuk mencegah perubahan laman di latar belakang",settings_saved:"Pengaturan disimpan",show_popup:"Tampilkan {$destUrl}",continue_blocking:"Lanjutkan pemblokiran",allow_from:"Izinkan popup di {$origDomain}",manage_pref:"Kelola pengaturan...",popup_text:"AdGuard mencegah situs web ini membuka {$numPopup} jendela popup",options:"Opsi",silence_noti:"Jangan tampilkan pesan ini di {$origDomain}"},it:{userscript_name:"AdGuard Popup Blocker",
on_navigation_by_popunder:"È probabile che questa transizione alla nuova pagina sia causata da un pop-under. Desideri proseguire?",aborted_popunder_execution:"Popup Blocker ha interrotto l'esecuzione di uno script per impedire il reindirizzamento in secondo piano",settings_saved:"Impostazioni salvate",show_popup:"Visualizza {$destUrl}",continue_blocking:"Continua a bloccare",allow_from:"Consenti pop-up per {$origDomain}",manage_pref:"Gestisci preferenze...",popup_text:"AdGuard ha impedito a questo sito web di aprire {$numPopup} finestre pop-up",
options:"Opzioni",silence_noti:"Non mostrare questo messaggio su {$origDomain}"},ja:{userscript_name:"AdGuard ポップアップブロッカー",on_navigation_by_popunder:"新しいページへの移動はポップアンダーによって生じた可能性があります。続行しますか？",aborted_popunder_execution:"ポップアップブロッカーはバックグラウンドリダイレクトを防ぐためにスクリプトの実行を中止しました",settings_saved:"設定保存完了",show_popup:"{$destUrl}を表示する",continue_blocking:"ブロッキングを続ける",allow_from:"{$origDomain}のポップアップを許可する",manage_pref:"設定を管理…",popup_text:"AdGuardはこのウェブサイトが{$numPopup}のポップアップウィンドウを開くのを防ぎました",options:"オプション",silence_noti:"{$origDomain}にこのメッセージを表示しない"},
ko:{userscript_name:"AdGuard 팝업 차단기",on_navigation_by_popunder:"이 새 페이지로의 이동은 팝언더 광고에 의한 것일 수 있습니다. 계속 하시겠습니까?",aborted_popunder_execution:"팝업 차단기가 백그라운드 리디렉션을 방지하기 위해 스크립트 실행을 중단하였습니다",settings_saved:"설정 저장됨",show_popup:"{$destUrl} 표시",continue_blocking:"계속 차단하기",allow_from:"{$origDomain}의 팝업 허용하기",manage_pref:"환경 설정 관리...",popup_text:"AdGuard가 이 웹사이트에서 {$numPopup}개의 팝업 창을 차단하였습니다",options:"옵션",silence_noti:"{$origDomain}에서 이 메세지 표시하지 않기"},lt:{userscript_name:"AdGuard iššokančiųjų langų blokatorius",
on_navigation_by_popunder:"Šis perėjimas į naują puslapį greičiausiai buvo įtakotas pop-under. Ar norite tęsti?",aborted_popunder_execution:"Iškylančių langų blokatorius nutraukė skripto vykdymą, kad būtų išvengta foninio peradresavimo",settings_saved:"Nustatymai išsaugoti",show_popup:"Rodyti {$destUrl}",continue_blocking:"Tęsti blokavimą",allow_from:"Leisti iššokančius langus {$origDomain}",manage_pref:"Tvarkyti nuostatas...",popup_text:"„AdGuard“ neleido šiai svetainei atidaryti {$numPopup} iššokančius langus",
options:"Parinktys",silence_noti:"Nerodyti šio pranešimo {$origDomain}"},ms:{userscript_name:"AdGuard Penyekat Pop Timbul",on_navigation_by_popunder:"Peralihan ke laman baru ini kemungkinan disebabkan oleh pop-bawah. Anda ingin meneruskan?",aborted_popunder_execution:"Penyekat Pop Timbul menggugurkan pelaksanaan skrip bagi mengelakkan arah semula latar belakang",settings_saved:"Tetapan disimpan",show_popup:"Tunjukkan {$destUrl}",continue_blocking:"Terus menyekat",allow_from:"Benarkan pop-timbul untuk {$origDomain}",
manage_pref:"Urus keutamaan...",popup_text:"AdGuard menghalang laman web ini daripada membuka {$numPopup} tetingkap pop-timbul",options:"Pilihan",silence_noti:"Jangan tunjuk mesej ini pada {$origDomain}"},no:{userscript_name:"AdGuards popup-blokkerer",on_navigation_by_popunder:"Omdirigeringen til den nye nettsiden er sannsynligvis forårsaket av en pop-under. Ønsker du å fortsette?",aborted_popunder_execution:"Popup Blocker avbrøt en skrift fra å kjøre for å hindre bakgrunnsomdirigering",settings_saved:"Innstillinger lagret",
show_popup:"Vis {$destUrl}",continue_blocking:"Fortsett blokkering",allow_from:"Tillat popup-vinduer for {$origDomain}",manage_pref:"Administrer preferanser…",popup_text:"AdGuard forhindret denne nettsiden i å åpne popup-vinduer for {$numPopup}",options:"Alternativer",silence_noti:"Ikke vis denne meldingen for {$origDomain}"},pl:{userscript_name:"Bloker wyskakujących okienek przez AdGuard",on_navigation_by_popunder:"To przejście na nową stronę może być spowodowane przez pop-under. Czy chcesz kontynuować?",
aborted_popunder_execution:"Bloker wyskakujących okienek przerwał wykonywanie skryptu, aby zapobiec przekierowaniu w tle",settings_saved:"Ustawienia zapisane",show_popup:"Pokaż {$destUrl}",continue_blocking:"Kontynuuj blokowanie",allow_from:"Zezwalaj na wyskakujące okienka dla {$origDomain}",manage_pref:"Zarządzaj preferencjami...",popup_text:"AdGuard zapobiegł na tej stronie otwarcie  {$numPopup} wyskakujacego okienka.",options:"Opcje",silence_noti:"Nie pokazuj tej wiadomości w {$origDomain}"},nl:{userscript_name:"AdGuard Pop-up Blocker",
on_navigation_by_popunder:"Deze overgang naar de nieuwe pagina wordt waarschijnlijk veroorzaakt door een onderliggend venster. Wil je doorgaan?",aborted_popunder_execution:"Pop-up Blocker heeft de uitvoering van een script afgebroken om een redirect in de achtergrond te voorkomen",settings_saved:"Instellingen opgeslagen",show_popup:"Toon {$destUrl}",continue_blocking:"Doorgaan",allow_from:"Sta pop-ups toe voor {$origDomain}",manage_pref:"Voorkeuren beheren...",popup_text:"AdGuard heeft voorkomen dat deze website pop-upvensters van {$numPopup} opende",
options:"Opties",silence_noti:"Dit bericht niet weergeven voor {$origDomain}"},pt:{userscript_name:"AdGuard Bloqueador de Pop-ups",on_navigation_by_popunder:"Essa transição para a nova página provavelmente será causada por um pop-under. Você deseja continuar?",aborted_popunder_execution:"O bloqueador de pop-ups interrompeu uma execução de script para evitar um redirecionamento em segundo plano",settings_saved:"Configurações salvas",show_popup:"Mostrar {$destUrl}",continue_blocking:"Continuar bloqueando",
...
settings_saved:"As definições foram guardadas",show_popup:"Mostrar {$destUrl}",continue_blocking:"Continuar a bloquear",allow_from:"Permitir popups em {$origDomain}",manage_pref:"Gerir preferências...",popup_text:"O AdGuard impediu que este sítio abrisse janelas popup de {$numPopup}",options:"Opções",silence_noti:"Não mostrar esta mensagem em {$origDomain}"},ro:{userscript_name:"Blocant Pop-up AdGuard",on_navigation_by_popunder:"Tranziția la această noua pagină este probabil cauzată de un pop-under. Vrei să continui?",
aborted_popunder_execution:"Blocantul Pop-up a oprit o execuție de script ca să prevină redirecționare în fundal",settings_saved:"Setări salvate",show_popup:"Arată {$destUrl}",continue_blocking:"Continuați blocarea",allow_from:"Permiteți pop-up pentru {$origDomain}",manage_pref:"Gestiune preferințe...",popup_text:"AdGuard a împiedicat acestui site să deschidă {$numPopup} ferestre pop-up",options:"Opțiuni",silence_noti:"Nu afișați acest mesaj pe {$origDomain}"},ru:{userscript_name:"Блокировщик всплывающей рекламы от AdGuard",
on_navigation_by_popunder:"Этот переход на новую страницу скорее всего вызван поп-андером. Всё равно продолжить?",aborted_popunder_execution:"Блокировщик всплывающей рекламы прервал исполнение скрипта, чтобы предотвратить фоновую переадресацию",settings_saved:"Настройки сохранены",show_popup:"Показать {$destUrl}",continue_blocking:"Продолжить блокировку",allow_from:"Разрешить всплывающие окна на {$origDomain}",manage_pref:"Управлять настройками...",popup_text:"AdGuard предотвратил показ {$numPopup} всплывающих окон на этом сайте",
options:"Опции",silence_noti:"Не показывать это сообщение на {$origDomain}"},sk:{userscript_name:"AdGuard blokovač vyskakovacích okien",on_navigation_by_popunder:"Tento prechod na novú stránku bude pravdepodobne spôsobený kontextovým oknom. Prajete si pokračovať?",aborted_popunder_execution:"Blokovanie vyskakovacích okien prerušilo vykonávanie skriptu, aby sa zabránilo presmerovaniu na pozadí",settings_saved:"Nastavenia boli uložené",show_popup:"Zobraziť {$destUrl}",continue_blocking:"Pokračovať v blokovaní",
allow_from:"Povoliť vyskakovacie okná pre {$origDomain}",manage_pref:"Spravovať preferencie...",popup_text:"AdGuard zabránil tejto stránke otvoriť {$numPopup} vyskakovacích okien",options:"Voľby",silence_noti:"Neukazovať túto správu na {$origDomain}"},sl:{userscript_name:"AdGuard Zaviralec pojavnih oken",on_navigation_by_popunder:"Ta prehod na novo stran je verjetno posledica pojavnega okna. Ali želite nadaljevati?",aborted_popunder_execution:"Zaviralec pojavnih oken je prekinil izvajanje skripta, da bi preprečil preusmerjanje v ozadju",
settings_saved:"Nastavitve so shranjene",show_popup:" Prikaži {$destUrl}",continue_blocking:"Nadaljuj z zaviranjem",allow_from:"Dovoli pojavna okna na {$origDomain}",manage_pref:"Upravljaj nastavitve...",popup_text:"AdGuard je tej spletni strani preprečil odpiranje {$numPopup} pojavnih oken",options:"Možnosti",silence_noti:"Ne prikazuj tega sporočila na {$origDomain}"},"sr-CS":{userscript_name:"AdGuard blokator iskačućih prozora",on_navigation_by_popunder:"Ovo preusmerenje na novu stranicu je verovatno uzrokovano iskačućim prozorom. Želite li da nastavite?",
aborted_popunder_execution:"Blokator iskačućih prozora je odbacio izvršenje skripte kako bi sprečio pozadinsko preusmerenje",settings_saved:"Postavke sačuvane",show_popup:"Prikaži {$destUrl}",continue_blocking:"Nastavi sa blokiranjem",allow_from:"Dozvoli iskačuće prozore za {$origDomain}",manage_pref:"Upravljaj postavkama...",popup_text:"AdGuard je sprečio ovaj sajt da otvori {$numPopup} iskačućih prozora",options:"Opcije",silence_noti:"Ne prikazuj ovu poruku na {$origDomain}"},ta:{userscript_name:"AdGuard பாப்அப் தடுப்பான்",
on_navigation_by_popunder:"புதிய பக்கத்திற்கான இந்த மாற்றம் ஒரு பாப்-அண்டர் காரணமாக ஏற்படக்கூடும். தொடர விரும்புகிறீர்களா?",aborted_popunder_execution:"பின்னணி திருப்பிவிடப்படுவதைத் தடுக்க பாப்அப் தடுப்பான் ஸ்கிரிப்ட் செயல்பாட்டை நிறுத்தியது",settings_saved:"அமைப்புகள் சேமிக்கப்பட்டன",show_popup:"{$destUrl} ஐக் காட்டு",continue_blocking:"தடுப்பதைத் தொடரவும்",allow_from:"{$origDomain} க்கு பாப்-அப்களை அனுமதிக்கவும்",manage_pref:"விருப்பங்களை நிர்வகிக்கவும்...",popup_text:"AdGuard இந்த வலைத்தளத்தை {$numPopup} பாப்-அப் திறப்பதைத் தடுத்தது",
options:"விருப்பங்கள்",silence_noti:"இந்த செய்தியை {$origDomain} இல் காட்ட வேண்டாம்"},th:{userscript_name:"AdGuard Popup Blocker",on_navigation_by_popunder:"การเปลี่ยนไปใช้หน้าใหม่นี้น่าจะเกิดจากป๊อปอันเดอร์ คุณต้องการทำต่อไปหรือไม่?",aborted_popunder_execution:"Popup Blocker ยกเลิกการทำงานของสคริปต์เพื่อป้องกันการเปลี่ยนพื้นหลัง",settings_saved:"การตั้งค่าที่บันทึกไว้",show_popup:"แสดง {$destUrl}",continue_blocking:"ปิดกั้นต่อไป",allow_from:"อนุญาตป๊อปอัปสำหรับ {$origDomain}",manage_pref:"จัดการค่ากำหนด...",
popup_text:"AdGuard ป้องกันไม่ให้เว็บไซต์นี้เปิดหน้าต่างป๊อปอัพ {$numPopup}",options:"ตัวเลือก",silence_noti:"อย่าแสดงข้อความนี้ใน {$origDomain}"},tr:{userscript_name:"AdGuard Açılır Pencere Engelleyici",on_navigation_by_popunder:"Yeni sayfaya geçiş, bir gizli pencere nedeniyle meydana gelmiş olabilir. Devam etmek istiyor musunuz?",aborted_popunder_execution:"Açılır Pencere Engelleyici arka plan yönlendirmesini önlemek için bir komut dosyasının çalışmasını durdurdu",settings_saved:"Ayarlar kaydedildi",
show_popup:"{$destUrl} sitesini göster",continue_blocking:"Engellemeye devam et",allow_from:"{$origDomain} için açılır pencerelere izin ver",manage_pref:"Tercihleri yönet...",popup_text:"AdGuard bu sitenin {$numPopup} açılır pencere açmasını önledi",options:"Ayarlar",silence_noti:"Bu mesajı {$origDomain} üzerinde gösterme"},uk:{userscript_name:"Блокувальник спливних вікон AdGuard",on_navigation_by_popunder:"Цей перехід на нову сторінку, ймовірно, міг бути викликаний «поп-андером». Бажаєте продовжити?",
aborted_popunder_execution:"Блокувальник спливних вікон перервав виконання скрипта, щоб запобігти фоновому перенаправленню",settings_saved:"Налаштування збережено",show_popup:"Показати {$destUrl}",continue_blocking:"Продовжити блокування",allow_from:"Дозволити спливні вікна для {$origDomain}",manage_pref:"Керувати налаштуваннями...",popup_text:"AdGuard запобіг показу спливних вікон {$numPopup} на цьому сайті",options:"Параметри",silence_noti:"Не показувати це повідомлення на {$origDomain}"},vi:{userscript_name:"AdGuard Popup Blocker",
on_navigation_by_popunder:"Việc chuyển đổi sang trang mới này có thể được gây ra bởi một cửa sổ bật xuống. Bạn có muốn tiếp tục?",aborted_popunder_execution:"Trình chặn Popup đã hủy bỏ việc thực thi tập lệnh để ngăn chuyển hướng nền",settings_saved:"Đã lưu cài đặt",show_popup:"Hiện {$destUrl}",continue_blocking:"Tiếp tục chặn",allow_from:"Cho phép cửa sổ bật lên cho {$origDomain}",manage_pref:"Quản lý tùy chọn...",popup_text:"AdGuard đã ngăn trang web này mở {$numPopup} cửa sổ bật lên",options:"Tuỳ chọn",
silence_noti:"Đừng hiển thị thông báo này trên {$origDomain}"},zh:{userscript_name:"AdGuard 弹窗拦截器",on_navigation_by_popunder:"此网页导航可能导致弹窗。您要继续？",aborted_popunder_execution:"PopupBlocker 已中止脚本执行以防止后台重新定向",settings_saved:"设置已保存",show_popup:"显示 {$destUrl}",continue_blocking:"继续拦截",allow_from:"允许 {$origDomain} 弹窗",manage_pref:"管理首选项...",popup_text:"AdGuard 已防止此网站打开的 {$numPopup} 个弹窗",options:"选项",silence_noti:"在 {$origDomain} 上不再显示此讯息"},"zh-HK":{userscript_name:"AdGuard 彈出式視窗封鎖器",on_navigation_by_popunder:"頁面轉跳可能是由彈出式視窗進行的，您要繼續嗎？",
aborted_popunder_execution:"彈出式視窗封鎖器已阻止網頁內的腳本運作避免網頁被重新導向",settings_saved:"已儲存設定",show_popup:"顯示 {$destUrl}",continue_blocking:"繼續封鎖",allow_from:"允許 {$origDomain} 的彈出式視窗",manage_pref:"管理偏好設定",popup_text:"AdGuard 已阻止此網站開啟 {$numPopup} 個彈出式視窗",options:"選項",silence_noti:"不再 {$origDomain} 上提示 "},"zh-TW":{userscript_name:"AdGuard 彈出式視窗封鎖器",on_navigation_by_popunder:"此至新的頁面之轉換很可能是由一個背彈式視窗引起。您想要繼續嗎？",aborted_popunder_execution:"彈出式視窗封鎖器已中止腳本執行以防止背景重新導向",settings_saved:"設定被儲存",show_popup:"顯示 {$destUrl}",continue_blocking:"繼續封鎖",
allow_from:"允許在 {$origDomain} 的彈出式視窗",manage_pref:"管理偏好設定…",popup_text:"AdGuard 已防止此網站開啟 {$numPopup} 個彈出式視窗",options:"選項",silence_noti:"不要於 {$origDomain} 上顯示該訊息"},hr:{userscript_name:"AdGuard Bloker skočnih prozora",on_navigation_by_popunder:"Prijelaz na novu stranicu je najvjerojatnije uzrokovan skrivenim skočnim prozorom. Želite li nastaviti?",aborted_popunder_execution:"Bloker skočnih prozora prekinuo je izvršavanje skripte kako bi spriječio preusmjeravanje u pozadini",settings_saved:"Postavke su spremljene",
show_popup:"Prikaži {$destUrl}",continue_blocking:"Nastavi blokirati",allow_from:"Dopusti skočne prozore za {$origDomain}",manage_pref:"Upravljanje postavkama...",popup_text:"AdGuard je spriječio ovu web stranicu da otvori {$numPopup} skočna prozora",options:"Opcije",silence_noti:"Ne pokazuj ovu poruku za {$origDomain}"}},Ed=Object.keys(Dd).map(function(a){return a.replace("_","-")}),Fd=null;function Gd(a){return-1!==Ed.indexOf(a)?(Fd=a,!0):!1}
if("undefined"===typeof AdguardSettings||!Gd(AdguardSettings.locale.replace("_","-"))){var Y=navigator.language.replace("_","-");if(!Gd(Y)){var Hd=Y.indexOf("-");-1!==Hd&&(Y=Y.slice(0,Hd));Gd(Y)||(Fd="en")}}function Cd(a){var b=Dd[Fd][a];b||(b=Dd.en[a]);return b};function jd(){this.a=GM_getResourceURL}function Vc(a){if(p(a.b)){var b=Id+"regular/OpenSans-Regular.woff",c=Id+"semibold/OpenSans-Semibold.woff",d=Id+"bold/OpenSans-Bold.woff",e=b+2,f=c+2,g=d+2;a.b=[a.a(b),a.a(e),a.a(c),a.a(f),a.a(d),a.a(g)]}return a.b}function Wc(a){return!Jd.test(a)}
function Uc(a){a=Vc(a);return'@font-face{font-family:"Open Sans";src:url('+a[1]+') format("woff2"),url('+a[0]+') format("woff");font-weight:400;font-style:normal}@font-face{font-family:"Open Sans";src:url('+a[3]+') format("woff2"),url('+a[2]+') format("woff");font-weight:600;font-style:normal}@font-face{font-family:"Open Sans";src:url('+a[5]+') format("woff2"),url('+a[4]+') format("woff");font-weight:700;font-style:normal}'}var Id="./assets/fonts/",Jd=/^data:/;var yc=new function(){this.B=Cd},id=new ud,Bd=new hd(function(){window.open("https://link.adtidy.org/forward.html?action=popup_blocker_options&from=content_script&app=popup_blocker","__popupBlocker_options_page__")}),Z=new X;if(2>parseFloat(GM_getValue("ver","1"))){var zd=[];vd(new yd);GM_setValue(od,zd.join(","));GM_setValue("ver","2")}function popupBlocker(window,CONTENT_SCRIPT_KEY){var n,aa="function"==typeof Object.create?Object.create:function(a){function b(){}b.prototype=a;return new b},ba;if("function"==typeof Object.setPrototypeOf)ba=Object.setPrototypeOf;else{var ca;a:{var da={na:!0},ea={};try{ea.__proto__=da;ca=ea.na;break a}catch(a){}ca=!1}ba=ca?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var fa=ba;var ha=Element.prototype.matches||Element.prototype.msMatchesSelector,ia="closest"in Element.prototype?function(a,b){return a.closest(b)}:function(a,b){for(;a;){if(ha.call(a,b))return a;a=a.parentElement}return null},ja=(Object.getOwnPropertyDescriptor(window,"frameElement")||Object.getOwnPropertyDescriptor(Window.prototype,"frameElement")).get,ka="attachShadow"in Element.prototype;var la=Object.prototype.toString;function p(a){return"undefined"===typeof a};var q=Object.defineProperty,r=Object.getOwnPropertyDescriptor,ma=Object.create,na=Object.keys,oa=Object.prototype.hasOwnProperty,pa=Function.prototype.apply,qa=Function.prototype.call,t=Function.prototype.bind,ra=Function.prototype.toString,sa=window.Proxy;if(sa)var ta=Reflect.apply;
var ua=window.MutationObserver||window.WebKitMutationObserver,va=window.MessageChannel,wa=window.setTimeout.bind(window),xa=r(HTMLIFrameElement.prototype,"contentWindow").get,ya=r(HTMLIFrameElement.prototype,"contentDocument").get,za=r(MessageEvent.prototype,"source").get,Aa=Error.captureStackTrace;
...
};var Kd="__PB"+(1E9*Math.random()>>>0)+"__";
Z.a?(Z.v=Z.v.bind(Z),Z.Z=Z.Z.bind(Z),Z.aa=Z.aa.bind(Z),unsafeWindow[Kd]=cloneInto(Z,unsafeWindow,{cloneFunctions:!0})):unsafeWindow[Kd]=Z;var Ld="undefined"!==typeof unsafeWindow?unsafeWindow.window:window;if(Z.a){var Md=document.createElement("script");Md.textContent="("+popupBlocker.toString()+")(this,'"+Kd+"')";var Nd=document.body||document.head||document.documentElement;Nd.appendChild(Md);Nd.removeChild(Md)}else popupBlocker(Ld,Kd);var Od=location.href;
if("https://adguardteam.github.io/PopupBlocker/options.html"===Od||"https://link.adtidy.org/forward.html?action=popup_blocker_options&from=content_script&app=popup_blocker"===Od||"http://localhost:8000/options.html"===Od)document.title=yc.B("userscript_name")||"Adguard Popup Blocker",Ld.GM_getValue=exportFunction(GM_getValue,unsafeWindow),Ld.GM_setValue=exportFunction(GM_setValue,unsafeWindow),Ld.GM_listValues=exportFunction(GM_listValues,unsafeWindow),unsafeWindow.AdguardSettings=AdguardSettings;
