...
(function () {
    ...
    if ($('.no-player').length === 1) {
        var mvideo = "<video id='my-video' controls><source src="+v_link_hd1+" type='video/mp4' /><source src="+v_link_hd2+" type='video/mp4' /><source src="+v_link1+" type='video/mp4' /><source src="+v_link2+" type='video/mp4' /></video>";
